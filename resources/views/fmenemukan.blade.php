...
<div class="container">
<div class="">
    <a href="" class="text-start" style="text-decoration: none;">Kembali ke Daftar Kehilangan</a><br><br>
    <form action="" style="width:1200px; background-color:white; padding:30px 30px 30px 30px;">
        ...
        <div class="mb-3 row">
         ...
         <div class="d-grid gap-2 col-3 mx-auto">
            <button class="btn btn-primary" type="button">Laporkan Barang Ditemukan!</button>
          </div></div>
    </form><br></body>
    @endsection
